...
namespace HGS.Tools
{
    public class HGSReorderableList
    {
        ...
        public delegate void ActionDelegate(HGSReorderableList list);
        public delegate bool ActionBoolDelegate(HGSReorderableList list);
        public delegate void AddDropdownDelegate(Rect buttonRect, HGSReorderableList list);
        public delegate Object DragDropReferenceDelegate(Object[] references, HGSReorderableList list);
        public delegate void DragDropAppendDelegate(Object reference, HGSReorderableList list);
        public delegate float GetElementHeightDelegate(SerializedProperty element);
        public delegate float GetElementsHeightDelegate(HGSReorderableList list);
        ...
        public HGSReorderableList(SerializedProperty list)
            : this(list, true, true, true)
        {
        }

        public HGSReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable)
            : this(list, canAdd, canRemove, draggable, ElementDisplayType.Auto, null, null, null)
        {
        }

        public HGSReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, Texture elementIcon)
            : this(list, canAdd, canRemove, draggable, elementDisplayType, elementNameProperty, null, elementIcon)
        {
        }

        public HGSReorderableList(SerializedProperty list, bool canAdd, bool canRemove, bool draggable, ElementDisplayType elementDisplayType, string elementNameProperty, string elementNameOverride, Texture elementIcon)
        {
