...
namespace HGS.Tools
{
	...
	{
		protected HGSReorderableList _list;
		...
		{
			_list = new HGSReorderableList(serializedObject.FindProperty("States"));
			_list.elementNameProperty = "States";
			_list.elementDisplayType = HGSReorderableList.ElementDisplayType.Expandable;
